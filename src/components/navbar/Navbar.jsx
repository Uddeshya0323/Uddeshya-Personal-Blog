...
export default function Nav() {
  ...
  const navList = (
    <ul className="mb-4 mt-2 flex flex-col gap-2 lg:mb-0 lg:mt-0 lg:flex-row lg:items-center lg:gap-6">
      <li className="p-1 font-normal" style={{ color: mode === "dark" ? "white" : "white" }}>
        <Link to="/" className=" flex items-center">
          <Typography as="span" className="text-white" variant="small" color="blue-gray">
            Home
          </Typography>
        </Link>
      </li>
              ...
              {admin && (
                <Link to="/dashboard">
                  <div>
                    <Avatar
                      key={1}
                      src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSpUrRpEqgaax3iRCPfi-ttIGHOpe-8xD7kRw&s"
                      alt="avatar"
                      withBorder={true}
