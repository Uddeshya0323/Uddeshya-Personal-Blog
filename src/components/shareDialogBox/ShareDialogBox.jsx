            ...
            <Dialog className=" relative right-[1em] w-[25em]  md:right-0 md:w-0 lg:right-0 lg:w-0" open={open} handler={handleOpen} style={{ background: mode === 'light' ? '#2f3542' : '#2f3542', color: mode === 'dark' ? 'white' : 'black' }}>
                ...
                <DialogBody >
                    <div className="flex justify-center flex-wrap  sm:mx-auto sm:mb-2 -mx-2  mt-4 mb-2 ">
                        ...
                        <div className="">
                            <div className="flex gap-3">
                                {/* Linkedin Icon  */}
                                <div className="">
                                    <a href="https://www.linkedin.com/in/uddeshya-patel-a247611b2?utm_source=share&utm_campaign=share_via&utm_content=profile&utm_medium=ios_app">
                                ...
                                {/* Instagram Icon  */}
                                <div className="">
                                    <a href="https://www.instagram.com/uddeshya0323?igsh=MTYzYzlzem8weHZqdA%3D%3D&utm_source=qr">
                    ...
                    <div className=" text-center">
                        <h1 className=" text-gray-600">Social Media</h1>
                    </div>
                </DialogBody>
            </Dialog>
        </Fragment>
